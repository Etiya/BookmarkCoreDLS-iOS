...
public enum TextStyles {
    ...
    /// Roboto-Small-Bold - 14
    public static let small_bold = TextStyle(font: FontsManager.fontFor(name: "Roboto-Bold", size: 14), color: Colors.fGray)
    
    /// Roboto-Regular - 8
    public static let micro = TextStyle(font: FontsManager.fontFor(name: "Roboto-Regular", size: 8), color: Colors.fGray)
    
    /// Roboto-Regular - 24
    public static let regular24  = TextStyle(font: FontsManager.fontFor(name: "Roboto-Regular", size: 24), color: Colors.fBlack)
    
    /// Roboto-Bold - 22
    public static let bold22     = TextStyle(font: FontsManager.fontFor(name: "Roboto-Bold", size: 22), color: Colors.fBlack)
    
    /// Roboto-Bold - 19
    public static let bold19     = TextStyle(font: FontsManager.fontFor(name: "Roboto-Bold", size: 19), color: Colors.fBlack)

    /// Roboto-Medium - 14
    public static let medium14   = TextStyle(font: FontsManager.fontFor(name: "Roboto-Medium", size: 14), color: Colors.fBlack)
